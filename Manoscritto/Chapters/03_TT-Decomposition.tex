...
\begin{Teo} \label{teo:ttsvd}
  ...
  \begin{proof}
    *\todo{In questa dimostrazione ci sono ancora dei punti poco chiari: vedila bene e semmai chiedi a Bini}
    ...
    \begin{equation*}
      A_1(i_1;i_2,\ldots,i_d) = \sum_{\alpha_1 = 1}^{r_1} U(i_1,\alpha_1) V^\top(\alpha_1;i_2,\ldots,i_d)
    \end{equation*}
    ...
    \end{equation*}
    We can now consider $V$ as a tensor and make $(\alpha_1 i_2)$ one long index, so that \V will be a $(d-1)$-dimensional tensor.
  \end{proof}
