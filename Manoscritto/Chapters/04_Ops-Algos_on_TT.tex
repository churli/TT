...
\todo{Davvero vogliamo fare delle sezioni così?}
...
\todo{Questa roba è troppo lunga, va fuori margine quando viene usata top pagina}
...
\paragraph{Hadamard product} The Hadamard product, defined in \ref{def:hadamard}, can be computed in the TT format as follows. Consider
\begin{equation*}
  \C = \A \circ \B
\end{equation*}
