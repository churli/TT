...
Ancora possiamo vedere, in \ref{fig:cats_noise}, come il rumore \todo{check if correct term} si propaghi lungo le fibre, rivelando la struttura stessa del formato TT: in \ref{fig:cats_noise_vertical} possiamo vedere come le figure dei due gatti diano origine ad alcune bande verticali di pixel più scuri, mentre in \ref{fig:cats_noise_time} si veda chiaramente in basso a destra la propagazione nella dimensione temporale di una sagoma proveniente da un altro frame.
